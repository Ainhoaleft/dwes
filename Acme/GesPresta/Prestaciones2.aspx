               ...
               <div class="filaForm">DATOS DE LAS PRESTACIONES</div>
                    <div class="casilla"> 
                         <div class="filaForm">
                             ...
                             Codigo Prestación<asp:TextBox ID="txtCodPre" runat="server"></asp:TextBox> 
                                </div>  
                            <div class="celda"> 
                    ...
                    <div class="casilla"> 
                        <div class="filaForm">Descripcion<asp:TextBox ID="txtDesPre" runat="server"></asp:TextBox>
                            </div>
                            <div class="celda">
                            </div>
                    </div>
                    <div class="casilla"> 
                        <div class="filaForm">Importe Fijo<asp:TextBox ID="txtImpPre" runat="server"></asp:TextBox>
                                 </div>
                             <div class="celda">
                ...
                <div class="casilla"> 
                        <div class="filaForm">Porcentaje del Importe<asp:TextBox ID="txtPorPre" runat="server"></asp:TextBox>
                                 </div>
                             <div class="celda">
                    ...
                    <div class="casilla"> 
                        <div class="filaForm">Tipo de Prestación<asp:DropDownList ID="ddlTipPre" runat="server">
